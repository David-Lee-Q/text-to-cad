...
function GitLogDialog({ open, onOpenChange }) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        <div className="relative flex h-[50dvh] w-full max-w-2xl min-w-0 flex-col gap-4 rounded-lg border border-white/10 bg-popover/75 p-6 text-popover-foreground shadow-2xl shadow-black/30 backdrop-blur-xl">
