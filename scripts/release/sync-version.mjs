...
const jsonTargets = [
  ...
  { path: "plugins/cad/skills/cad-viewer/scripts/viewer/packages/implicitjs/package.json", fields: [["version"]], required: false },
  {
    path: "plugins/cad/skills/cad-viewer/scripts/viewer/packages/implicitjs/package-lock.json",
    fields: [["version"], ["packages", "", "version"]],
    required: false,
  },
  { path: "plugins/cad/skills/implicit-cad/scripts/packages/implicitjs/package.json", fields: [["version"]], required: false },
  {
    path: "plugins/cad/skills/implicit-cad/scripts/packages/implicitjs/package-lock.json",
    fields: [["version"], ["packages", "", "version"]],
    required: false,
  },
];
